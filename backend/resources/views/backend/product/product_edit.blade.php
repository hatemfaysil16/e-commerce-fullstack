...
<div class="mb-3">
 <label for="formFile" class="form-label">Product Thumbnail </label>
	<input type="text" name="old_thumbnail" value="{{ $product->image }}">
	 <input class="form-control" name="image" type="file" id="image">
	 </div>

	 <div class="mb-3">
	 	<img id="showImage" src="{{ asset(App\Models\ProductList::IMAGE_PATH.$product->image )   }}" style="width:100px; height: 100px;" > 
	 </div>
 ...
 <label for="formFile" class="form-label">Image One</label>
		<input type="text" name="old_image_one" value="{{ $details[0]->image_one }}">
	 <input class="form-control" name="image_one" type="file"  >
	 <img  src="{{ asset(App\Models\ProductList::IMAGE_PATH.$details[0]->image_one )   }}" style="width:100px; height: 100px;" > 

	 </div>

	 	 <div class="mb-3">
 <label for="formFile" class="form-label">Image Two</label>
		<input type="text" name="old_image_two" value="{{ $details[0]->image_two }}">
	 <input class="form-control" name="image_two" type="file"  >
	 <img  src="{{ asset(App\Models\ProductList::IMAGE_PATH.$details[0]->image_two )   }}" style="width:100px; height: 100px;" > 

	 </div>

	 	 <div class="mb-3">
 <label for="formFile" class="form-label">Image Three</label>
		<input type="text" name="old_image_three" value="{{ $details[0]->image_three }}">
	 <input class="form-control" name="image_three" type="file"  >
	 <img  src="{{ asset(App\Models\ProductList::IMAGE_PATH.$details[0]->image_three )   }}" style="width:100px; height: 100px;" > 

	 </div>

	 	 <div class="mb-3">
 <label for="formFile" class="form-label">Image Four</label>
		<input type="text" name="old_image_four" value="{{ $details[0]->image_four }}">
	 <input class="form-control" name="image_four" type="file"  >
	 <img  src="{{ asset(App\Models\ProductList::IMAGE_PATH.$details[0]->image_four )   }}" style="width:100px; height: 100px;" > 
...
<div class="border border-3 p-4 rounded">
  <div class="row g-3">
	<div class="col-md-6">
	  ...
	  <div class="col-md-6">
		<label for="inputCompareatprice" class="form-label">star</label>
		<input type="number" name="star" class="form-control" id="inputCompareatprice" value="{{ $product->star }}">
	  </div>
	...
	$(document).ready(function() {
	  $('select[name="category_id"]').on('change', function(){
		  ...
		  if(category_id) {
			  ...
			  $.ajax({
				  url: "{{  url('/slider/subcategory/ajax') }}/"+category_id,
				  type:"GET",
				  dataType:"json",
