...
class ProductDetails extends Component {
     ...
     render() {
          ...
          let title = ProductAllData['productList']['title'];
          let brand = ProductAllData['productList']['brand'];
          let category = ProductAllData['productList']['category_id'];
          let subcategory = ProductAllData['productList']['subcategory_id'];
          let image = ProductAllData['productList']['image'];

          if(this.state.previewImg === "0"){
               this.setState({previewImg:image})
          }

          let price = ProductAllData['productList']['price'];
          let product_code = ProductAllData['productList']['product_code'];
          let remark = ProductAllData['productList']['remark'];
          let special_price = ProductAllData['productList']['special_price'];
          let star = ProductAllData['productList']['star'];
         

     let image_one = ProductAllData['productDetails']['image_one'];
     let image_two = ProductAllData['productDetails']['image_two'];
     let image_three = ProductAllData['productDetails']['image_three'];
     let image_four = ProductAllData['productDetails']['image_four'];
     let color = ProductAllData['productDetails']['color'];
     let size = ProductAllData['productDetails']['size'];

     let product_id = ProductAllData['productDetails']['product_id'];
     let short_description = ProductAllData['productDetails']['short_description'];
     let long_description = ProductAllData['productDetails']['long_description'];
